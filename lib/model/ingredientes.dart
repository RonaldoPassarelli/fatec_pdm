...
class Ingredientes {
  ...
  //Construtor
  Ingredientes(this._id, this._codrec, this._ingrediente, this._unidade, this._valor);
  ...
  Ingredientes.fromMap(Map<String, dynamic> map, String id) {
